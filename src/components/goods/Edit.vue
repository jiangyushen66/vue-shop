        ...
        <el-tabs v-model="activeIndex" tab-position="left" :before-leave="beforeTabLeave" @tab-click="tabClicked">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品分类">
              <el-cascader v-model="editForm.goods_cat" :options="cateList" :props="cascaderProps" @change="handleChange" clearable width="50%"></el-cascader>
            </el-form-item>
          </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    async getCateList() {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('获取商品的分类列表失败')
      }
    ...
    editGoods() {
      this.$refs.editFormRef.validate(async (valid) => {
         ...
         */
        // 处理商品所属分类的数据
        // this.editForm.goods_cat = this.editForm.goods_cat.join(',') // 会导致级联选择器关联的goods_cat发生异常
        // const form = this.editForm // 浅拷贝
        // 使用lodash工具
